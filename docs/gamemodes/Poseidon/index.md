...
- Rencontres défiant : Affrontez les noyés impitoyables, les monstres marins et les secrets enfouis.
- Le Nether rempli d'eau : Découvrez une version immergée de l'enfer.
- Défis inspirés par une histoire : Complétez des quêtes multi-niveaux et débloquez des livres mystérieux.
- Îles de démarrage personnalisées : Choisissez votre début.

## Configuration

La configuration est similaire à d'autres modes de jeu de BentoBox avec une section spécialement pour les paramètres de Poseidon. Dans Poseidon, les îles sont appelées royaumes.
